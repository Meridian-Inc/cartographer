...
class TestShouldNotifyUser:
    ...
    def test_should_notify_user_priority_below_minimum(self, dispatch_service, mock_prefs, sample_event):
    ...
    def test_should_notify_user_priority_with_override(self, dispatch_service, mock_prefs, sample_event):
    ...
    def test_should_notify_user_invalid_priority_override(self, dispatch_service, mock_prefs, sample_event):
...
class TestQuietHours:
    ...
    def test_should_notify_user_quiet_hours_not_in_quiet(self, dispatch_service, mock_prefs, sample_event):
    ...
    def test_should_notify_user_quiet_hours_blocked(self, dispatch_service, mock_prefs, sample_event):
    ...
    def test_should_notify_user_quiet_hours_bypass(self, dispatch_service, mock_prefs, sample_event):
...
class TestSendToUser:
    ...
    async def test_send_to_user_email_configured(self, dispatch_service, sample_event):
        ...
        with patch('app.services.notification_dispatch.user_preferences_service') as mock_ups:
            ...
            with patch('app.services.notification_dispatch.is_email_configured', return_value=True):
                with patch('app.services.notification_dispatch.send_notification_email', new_callable=AsyncMock) as mock_send:
    ...
    async def test_send_to_user_email_not_configured(self, dispatch_service, sample_event):
        ...
        with patch('app.services.notification_dispatch.user_preferences_service') as mock_ups:
            ...
            with patch('app.services.notification_dispatch.is_email_configured', return_value=False):
                records = await dispatch_service.send_to_user(
                    mock_db, "user-123", "network-123", sample_event
                )
    ...
    async def test_send_to_user_discord_not_configured(self, dispatch_service, sample_event):
        ...
        with patch('app.services.notification_dispatch.user_preferences_service') as mock_ups:
            ...
            with patch('app.services.notification_dispatch.is_discord_configured', return_value=False):
                records = await dispatch_service.send_to_user(
                    mock_db, "user-123", "network-123", sample_event
                )
