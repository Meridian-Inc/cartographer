...
class HealthChecker:
    ...
    def _record_test_ip_check(self, gateway_ip: str, test_ip: str, success: bool, latency_ms: float | None):
    ...
    async def check_test_ip(self, gateway_ip: str, test_ip: str, label: str | None = None) -> GatewayTestIPMetrics:
