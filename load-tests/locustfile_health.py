...
class HealthServiceUser(HttpUser):
    """
    ...
    def get_monitoring_config(self):
        ...
        self.client.get("/api/health/monitoring/config")
    
    @task(3)
    @tag("monitoring", "read")
    def get_monitored_devices(self):
        """Get list of monitored devices"""
        self.client.get("/api/health/monitoring/devices")
    ...
    def get_all_gateway_test_ips(self):
        ...
        self.client.get("/api/health/gateway/test-ips/all")
    ...
    def get_all_speed_tests(self):
        ...
        self.client.get("/api/health/speedtest/all")
    ...
    def clear_cache(self):
        ...
        self.client.delete("/api/health/cache")
