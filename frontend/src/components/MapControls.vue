		...
		<div class="flex items-center gap-1">
			...
			<div class="flex items-center gap-1 p-1 rounded-lg bg-slate-100/80 dark:bg-slate-800/50">
				...
				<button 
					v-if="!loading"
					@click="runMapper" 
					class="group flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium transition-all bg-gradient-to-r from-teal-500 to-emerald-500 text-white hover:from-teal-400 hover:to-emerald-400 shadow-sm shadow-teal-500/20 disabled:opacity-40 disabled:cursor-not-allowed"
